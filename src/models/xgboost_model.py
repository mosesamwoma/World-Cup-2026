...
def get_model() -> XGBClassifier:
    return XGBClassifier(
        ...
        # FIXED: removed use_label_encoder=False — deprecated and removed in XGBoost 2.x
        random_state=42,
        n_jobs=-1,
    )
...
def train(df: pd.DataFrame) -> XGBClassifier:
    ...
    Uses temporal order — never random split.
    """
...
def predict_proba(model: XGBClassifier, features: dict) -> dict:
    ...
    # proba order from LABEL_MAP: 0=away win, 1=draw, 2=home win
